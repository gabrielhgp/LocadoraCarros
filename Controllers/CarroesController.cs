...
namespace LocadoraCarros.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(AppCont context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Marca,Ano,Cor")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Marca,Ano,Cor")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
